...
import static gavs.first.com.home.Utils.url_courier_send;

public class Send_Fragment extends SessionTimeOutBaseFragment {

    public static final String PREFERENCES_FILE_NAME = "SIGNAGE";
    EditText etItem,etTo;

    RadioButton personal,official,international,domestic;
    Button btnSubmit;

    String _destination="", _to="",_mode="",_type = "";
    View view;
    String ip="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.sendfragment_layout,container,false);
        ...
        project = myprefs.getString("projectName","");
        ip=myprefs.getString("ip","");


        //Declare all the widgets used
        etItem = view.findViewById(R.id.etdomesticitem);
        etTo = view.findViewById(R.id.etdomesticto);
        ...
        domestic = view.findViewById(R.id.rbdomestic);
        international = view.findViewById(R.id.rbinternational);



        //get value of radiobutton of personal or official
        ...
        //get value of radiobutton of domestic or international

        domestic.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {

                _mode = domestic.getText().toString();
        ...
        international.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                _mode = international.getText().toString();
            }
        });
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //***_item is destination***
                _destination = etItem.getText().toString();
                _to = etTo.getText().toString();

                if(_destination.equals("") || _to.equals("")||_mode.equals(""))
                {
                    if (_destination.equals(""))
                    {
                        etItem.setError("Enter Destination");
                    }
                    if(_to.equals(""))
                    {
                        etTo.setError("Enter Recipient Name");
                    }
                    if (_mode.equals(""))
                    {
                        Toast.makeText(getContext(),"Select the type of courier",Toast.LENGTH_LONG).show();
                    }
                }else {
                    if (submitcount == 0) {
    ...
    class postMethod extends AsyncTask<String, String, Boolean>
    {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            try {
                ...
                obj.put("empId", empId);
                obj.put("sendToName", _to);
                obj.put("courierType", _mode); //20-12-18 changed key from mode to courierType
                obj.put("destination", _destination);
                obj.put("isadmin","no");

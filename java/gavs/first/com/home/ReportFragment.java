...
import static gavs.first.com.home.Utils.url_lost_report;

public class ReportFragment extends SessionTimeOutBaseFragment {

    EditText etItem, etDescription, etColor;
    View view;
    long empId;
    int responseCode;
    String ip = "", TAG = "";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.reportfragment_layout, container, false);
        ...
        btnSubmit = view.findViewById(R.id.btnreportsubmit);

        //get the values to strings from edittext
        ...
        etItem.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (etItem.getText().toString().length() >= 20) {
                    etItem.setError("You have exceeded the limit");
                }
            }
        ...
        etDescription.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                resetDisconnectTimer();
                if (etDescription.getText().toString().length() >= 20) {
                    etDescription.setError("You have exceeded the limit");
                }
            }
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (item.isEmpty() || description.isEmpty()) {
                    if (item.isEmpty()) {
                        etItem.setError("Fill with Item name");
                        //Toast.makeText(getActivity(),"Fill with Item name",Toast.LENGTH_LONG).show();
                    }
                    if (description.isEmpty()) {
                        etDescription.setError("Fill the description");
                        //Toast.makeText(getActivity(),"Fill the description",Toast.LENGTH_LONG).show();
                    }
    ...
    public class postMethod extends AsyncTask<String, String, Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            try {
                ...
                obj.put("name", name);
                obj.put("empId", empId);
                obj.put("materialName", item);
                obj.put("materialDesc", description);
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    //Toast.makeText(Activity.this, "Server not connected", Toast.LENGTH_LONG).show();
                    //return false;
                }
...
//                alertDialog.setIcon(R.drawable.ic_verified);
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if (responseCode == 200) {
                ...
                Toast.makeText(getContext(), "Oops..Try again", Toast.LENGTH_LONG).show();
                dialog.dismiss();
            } else {
